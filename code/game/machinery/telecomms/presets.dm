...
/obj/structure/machinery/telecomms/receiver/preset
	...
	freq_listening = list(COMM_FREQ, ENG_FREQ, SEC_FREQ, MED_FREQ, REQ_FREQ, SENTRY_FREQ, WY_WO_FREQ, PMC_FREQ, DUT_FREQ, PKT_FREQ, YAUT_FREQ, JTAC_FREQ, INTEL_FREQ, WY_FREQ, HC_FREQ, PVST_FREQ, SOF_FREQ)
...
/obj/structure/machinery/telecomms/server/presets/centcomm
	id = "CentComm Server"
	freq_listening = list(WY_WO_FREQ, PMC_FREQ, DUT_FREQ, PKT_FREQ, YAUT_FREQ, HC_FREQ, PVST_FREQ, SOF_FREQ, CBRN_FREQ)
