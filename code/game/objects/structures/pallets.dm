/obj/structure/pallet
	name = "wooden pallet"
	desc = "A pallet made of cheap synthwood used for storing large amounts of items. <b>Use a Wrench to Unanchor, Crowbar to Dismantle, Pen to re-lable, Stamp to Mark, and powerloader to move when loaded.</b>."
	...
	if(istype(O, /obj/item/tool/pen))
		...
		switch(pallet_action_choice)
			...
			if("Change Manifest")
				...
				if(new_desc != desc) desc = "This pallet contains [new_desc].  <b>Use a Wrench to Unanchor, Crowbar to Dismantle, Pen to re-lable, Stamp to Mark, and powerloader to move when loaded.</b>."
...
/obj/structure/pallet/standard
	...
	desc = "This pallet contains x18 empty boxes.<b>Use a Wrench to Unanchor, Crowbar to Dismantle, Pen to re-lable, Stamp to Mark, and powerloader to move when loaded.</b>."
...
/obj/structure/pallet/standard/med
	...
	desc = "This pallet contains x18 empty med boxes. <b>Use a Wrench to Unanchor, Crowbar to Dismantle, Pen to re-lable, Stamp to Mark, and powerloader to move when loaded.</b>."
	fill_type = /obj/item/storage/box/wood/med
	type_icon = "overlay_med"

/obj/structure/pallet/standard/med/firstaid
	name = "Pallet of - (First Aid kit Boxes)"
	desc = "This pallet contains x18 med boxes. <b>Use a Wrench to Unanchor, Crowbar to Dismantle, Pen to re-lable, Stamp to Mark, and powerloader to move when loaded.</b>."
	fill_type = /obj/item/storage/box/wood/med/full

/obj/structure/pallet/standard/engi
	name = "Pallet of - (Empty Engineering Boxes)"
	desc = "This pallet contains x18 empty engi boxes. <b>Use a Wrench to Unanchor, Crowbar to Dismantle, Pen to re-lable, Stamp to Mark, and powerloader to move when loaded.</b>."
	fill_type = /obj/item/storage/box/wood/engi
	type_icon = "overlay_construction"

/obj/structure/pallet/standard/engi/fob
	name = "Pallet of - (FOB Mats Boxes)"
	desc = "This pallet contains x18 assorted FOB material engi boxes. <b>Use a Wrench to Unanchor, Crowbar to Dismantle, Pen to re-lable, Stamp to Mark, and powerloader to move when loaded.</b>."
	fill_type = /obj/item/storage/box/wood/engi/full

/obj/structure/pallet/standard/food
	name = "Pallet of - (Empty Food Boxes)"
	desc = "This pallet contains x18 empty Food boxes. <b>Use a Wrench to Unanchor, Crowbar to Dismantle, Pen to re-lable, Stamp to Mark, and powerloader to move when loaded.</b>."
	fill_type = /obj/item/storage/box/wood/food
	type_icon = "overlay_food"

/obj/structure/pallet/standard/food/groceries
	name = "Pallet of - (Asst. Food Boxes)"
	desc = "This pallet contains x18 assorted raw food boxes. <b>Use a Wrench to Unanchor, Crowbar to Dismantle, Pen to re-lable, Stamp to Mark, and powerloader to move when loaded.</b>."
	fill_type = /obj/item/storage/box/wood/food/groceries

/obj/structure/pallet/standard/food/mres
	name = "Pallet of - (MRE Boxes)"
	desc = "This pallet contains x18 MRE Food boxes. <b>Use a Wrench to Unanchor, Crowbar to Dismantle, Pen to re-lable, Stamp to Mark, and powerloader to move when loaded.</b>."
	fill_type = /obj/item/ammo_box/magazine/misc/mre

/obj/structure/pallet/standard/weapon
	name = "Pallet of - (Empty Weapon Boxes)"
	desc = "This pallet contains x18 empty Weapon boxes. <b>Use a Wrench to Unanchor, Crowbar to Dismantle, Pen to re-lable, Stamp to Mark, and powerloader to move when loaded.</b>."
	fill_type = /obj/item/storage/box/wood/weapon
	type_icon = "overlay_ammo"

/obj/structure/pallet/standard/weapon/mk1
	name = "Pallet of - (Mk1 Pulse Rifle Boxes)"
	desc = "This pallet contains x54 Mk1 Pulse Rifles. <b>Use a Wrench to Unanchor, Crowbar to Dismantle, Pen to re-lable, Stamp to Mark, and powerloader to move when loaded.</b>."
	fill_type = /obj/item/storage/box/wood/weapon/mk1

/obj/structure/pallet/standard/he_mortar
	name = "Pallet of - (HE Mortar Shells)"
	desc = "This pallet contains x288 HE mortar shells <b>Use a Wrench to Unanchor, Crowbar to Dismantle, Pen to re-lable, Stamp to Mark, and powerloader to move when loaded.</b>."
...
/obj/structure/pallet/standard/ammo_mk1
	...
	desc = "This pallet contains x18 M41A MK1 AP Magazine Boxes. <b>Use a Wrench to Unanchor, Crowbar to Dismantle, Pen to re-lable, Stamp to Mark, and powerloader to move when loaded.</b>."
