...
/datum/emergency_call/forecon/create_member(datum/mind/new_mind, turf/override_spawn_loc)
	...
	if(!leader && HAS_FLAG(mob.client.prefs.toggles_ert, PLAY_LEADER) && check_timelock(mob.client, JOB_SQUAD_LEADER, time_required_for_job))
		leader = mob
		arm_equipment(mob, /datum/equipment_preset/uscm/forecon/leader/full, TRUE, TRUE)
		...
		arm_equipment(mob, /datum/equipment_preset/uscm/forecon/sg/full, TRUE, TRUE)
		...
		arm_equipment(mob, /datum/equipment_preset/uscm/forecon/rfm/full, TRUE, TRUE)
