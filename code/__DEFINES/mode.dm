...
GLOBAL_LIST_INIT(ROLES_MS, list(JOB_MS_GC, JOB_MS_PC, JOB_MS_SL, JOB_MS_ENGINEER, JOB_MS_MEDIC, JOB_MS_SMARTGUNNER, JOB_MS_RFM, JOB_MS_INTEL, JOB_MS_PILOT, JOB_MS_CREWMAN, JOB_SYNTH, JOB_COMBAT_REPORTER, JOB_POLICE, JOB_MAINT_TECH, JOB_MESS_SERGEANT, JOB_CHIEF_REQUISITION))
