...
#define ALL_HUMAN_LANGUAGES list(LANGUAGE_ENGLISH, LANGUAGE_JAPANESE, LANGUAGE_CHINESE, LANGUAGE_RUSSIAN, LANGUAGE_GERMAN, LANGUAGE_FRENCH, LANGUAGE_CELTIC, LANGUAGE_FARSI, LANGUAGE_ARABIC, LANGUAGE_SWEDISH, LANGUAGE_FINNISH, LANGUAGE_LATIN, LANGUAGE_SPANISH, LANGUAGE_BERBER, LANGUAGE_BANTU, LANGUAGE_HINDI)

#define ALL_SYNTH_LANGUAGES list(LANGUAGE_ENGLISH, LANGUAGE_JAPANESE, LANGUAGE_CHINESE, LANGUAGE_RUSSIAN, LANGUAGE_GERMAN, LANGUAGE_FRENCH, LANGUAGE_CELTIC, LANGUAGE_FARSI, LANGUAGE_ARABIC, LANGUAGE_SWEDISH, LANGUAGE_FINNISH, LANGUAGE_LATIN, LANGUAGE_SPANISH, LANGUAGE_BERBER, LANGUAGE_BANTU, LANGUAGE_HINDI, LANGUAGE_YAUTJA, LANGUAGE_XENOMORPH)
