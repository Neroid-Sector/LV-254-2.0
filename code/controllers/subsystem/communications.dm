...
#define TIS_FREQ 1225
#define PKT_FREQ 1728
#define LASS_FREQ 1892
...
GLOBAL_LIST_INIT(radiochannels, list(
	...
	RADIO_CHANNEL_TIS = TIS_FREQ,
	RADIO_CHANNEL_PKT = PKT_FREQ,
	RADIO_CHANNEL_LASS = LASS_FREQ,
...
// Response Teams
#define ERT_FREQS list(VAI_FREQ, DUT_FREQ, PKT_FREQ, LASS_FREQ, YAUT_FREQ, CMB_FREQ, RMC_FREQ)
